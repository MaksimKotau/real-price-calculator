...
const MainView: React.FC<{}> = () => {
  ...
  const [calculationTab, setCalculationTab] = useState<CalculationType>(
  ...
  return (
    <div className={classes.mainContainer}>
      <AppBar position='static'>
        <Toolbar
          className={isBrowser ? classes.desktopToolbar : classes.mobileToolbar}
        >
          <IconButton
            edge='start'
          ...
          <IconButton color='inherit' onClick={handleClearIconClick}>
            <MoreIcon />
          </IconButton>
        </Toolbar>
        <Tabs
      ...
      <SettingsMenu anchorEl={menuAnchorEl} onClose={handleCloseMenu} />
      <ClearMenu
...
const getClearLabel = (
  ...
  calculationTab: CalculationType
): string => {
  if (activeHistory) {
