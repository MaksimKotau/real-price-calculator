import {
  getWeightMaxId,
  getWeightMinId,
} from "../../views/calculatorTabs/WeightTab";
import {
  WeightCompareData,
  VolumeCompareData,
  CountCompareData,
...
import {
  getVolumeMaxId,
  getVolumeMinId,
} from "../../views/calculatorTabs/VolumeTab";
import {
  getCountMaxId,
  getCountMinId,
} from "../../views/calculatorTabs/CountTab";
...
describe("Best-Pire price find", () => {
  describe("Find Weight ID", () => {
    ...
    it("Find max value among almost the same values", () => {
      const elements: WeightCompareData[] = [
        {
          id: 1,
          unitType: WeightType.kilogram,
  ...
  it("Find max value among almost the same values", () => {
    ...
    expect(getWeightMinId(elements)).toEqual(1);
  });
  describe("Find Volume ID", () => {
    ...
    it("Find max value among the values thal almost the same", () => {
      const elements: VolumeCompareData[] = [
        {
          id: 1,
          unitType: VolumeType.liter,
      ...
      expect(getVolumeMaxId(elements)).toEqual(2);
    });
    ...
    it("Find min value among the values thal almost the same", () => {
      const elements: VolumeCompareData[] = [
        {
          id: 1,
          unitType: VolumeType.liter,
      ...
      expect(getVolumeMinId(elements)).toEqual(1);
    });
  });
  describe("find Count ID", () => {
    ...
    it("find max value among values that are almost the same", () => {
      const elements: CountCompareData[] = [
        {
          id: 1,
          count: 1,
      ...
      expect(getCountMaxId(elements)).toEqual(2);
    });
    ...
    it("find min value among values that are almost the same", () => {
      const elements: CountCompareData[] = [
        {
          id: 1,
          count: 1,
